# Sending-Emails-MicrosoftGraphAPI
Scripts for sending emails with Microsoft Graph API on Azure. Includes setting up access token on Azure using MSAL's Public Client Application approach. 
